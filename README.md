...
- Every item in the current primary navigation is available, and Privacy is available from the footer. The approved Airbnb listing, Facebook page, Messenger conversation, and two caretaker telephone contacts can be active from validated environment configuration; WhatsApp, map, owner-phone, email, and other external destinations remain disabled because no complete approved value has been supplied.
...
The remaining publishing blockers include approved Google Maps destinations, public owner contact details, Blue/Green Kubo and confirmed parking photos, a higher-resolution front-of-villa hero, rates and extra fees, exact expanded capacity, kubo and beach-cottage inclusion, the lost-key fee, bathroom layout, washer availability, inquiry-form status, and language choice. See `CONTENT_TODO.md` for the authoritative list.
