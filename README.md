...
- Every item in the current primary navigation is available, and Privacy is available from the footer. The approved Airbnb listing, Facebook page, Messenger conversation, WhatsApp contact, Google Maps/Waze pin, Nida caretaker telephone, and public email can be active from validated environment configuration; owner-phone and other external destinations remain disabled because no complete approved value has been supplied.
