...
`villa-vessela/` contains 41 owner-supplied, privacy-reviewed JPEG photographs grouped by attraction, bathroom, food, interior, lifestyle, and property. Six optimized attraction crops from the supplied nearby-attractions PDF are integrated as four new records and two improved replacements; the raster PDF pages themselves, earlier source-collage reference sheets, and passenger-boat photograph are deliberately excluded from the public bundle. `placeholders/` retains repository-native SVG illustrations for unresolved positions; the public gallery currently uses only the generic illustration for Blue Kubo, Green Kubo, and confirmed parking. The location illustration remains a fail-closed fallback, while production offers opt-in zoomable Google Maps and Waze for the verified pin.
