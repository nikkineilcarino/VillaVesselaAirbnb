...
- `e2e/discovery-contact.spec.ts` verifies public access/navigation, all 37 gallery photographs and three open slots, lightbox focus/keyboard/image-fit behavior, review provenance, Messenger placeholders, clipboard copying, inactive map/contact destinations, the disabled no-action inquiry preview, mobile overflow, and Axe results on all four routes.
