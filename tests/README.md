...
- `e2e/discovery-contact.spec.ts` verifies public access/navigation, all 37 gallery photographs and three open slots, lightbox focus/keyboard/image-fit behavior, review provenance, Messenger placeholders, clipboard copying, opt-in Google Maps/Waze switching and zoom, unapproved contact destinations, exact configured caretaker telephone links, the disabled no-action inquiry preview, mobile overflow, and Axe results on all four routes.
