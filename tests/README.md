...
- `e2e/homepage.spec.ts` verifies required homepage sections, important facts and qualifiers, inactive unverified destinations, local labelled placeholders, and working About/location anchors.
...
- `e2e/discovery-contact.spec.ts` verifies Phase 5 public access/navigation, all gallery categories, lightbox focus/keyboard/image-fit behavior, review provenance, Messenger placeholders, clipboard copying, inactive map/contact destinations, the disabled no-action inquiry preview, mobile overflow, and Axe results on all four routes.
